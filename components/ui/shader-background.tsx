...
const ShaderBackground: React.FC<ShaderBackgroundProps> = ({ className }) => {
  ...
  // Fragment shader source code - Subtle blue/indigo theme
  const fsSource = `
    ...
    // Subtle blue/indigo line color
    const vec4 lineColor = vec4(0.25, 0.35, 0.7, 0.6);
    ...
    void main() {
      ...
      vec4 bgColor1 = vec4(0.03, 0.03, 0.07, 1.0);
      vec4 bgColor2 = vec4(0.05, 0.04, 0.10, 1.0);
